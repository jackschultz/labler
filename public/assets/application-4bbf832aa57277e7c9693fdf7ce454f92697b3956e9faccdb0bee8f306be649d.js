...
(function() {
  $(document).on('ready page:load', function() {
    $("input[name=responses\\[secondary_group\\]]:radio").change(function() {
      if (this.value === "other") {
        return $(".secondary-other-text").show();
      } else {
        return $(".secondary-other-text").hide();
      }
    });
    return $("input[name=responses\\[primary_group\\]]:radio").change(function() {
      if (this.value === "other") {
        return $(".primary-other-text").show();
      } else {
        return $(".primary-other-text").hide();
      }
    });
  });
