...
$(document).ready(function() {
  ...
  $("input[name=responses\\[secondary_group\\]]:radio").change(function() {
    if (this.value == "other") {
      $(".secondary-other-text").show();
    }
    else
      $(".secondary-other-text").hide();
   });

  $("input[name=responses\\[primary_group\\]]:radio").change(function() {
    if (this.value == "other") {
      $(".primary-other-text").show();
    }
    else
      $(".primary-other-text").hide();
   });
